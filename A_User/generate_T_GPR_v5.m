...
%% 训练
for i = 1:1
    dataFileName_train = dataFileName_train_set{i};
    data_temp = load(['C:\MMMLY\KUKA_Matlab_client\A_User\Data\EnergyConsumption\',dataFileName_train]);
...
%% i 代表 不同的 v-state
for i = 1:3
disp(['Training!  !  v-state == ', num2str(i)])
tic
switch i
    case 1
