function [J, A_mat_products] = KUKA_Jacobian(joints,robot_type)
% Kuka_Jacobian: Get jacobina matrix of Kuka iiwa
% Calculates Jacobian of iiwa
% Copy from Motion-Planning-for-Kuka-LBR-main
...
l = zeros(1,4);
if robot_type == 0
    l = [0.34 0.4 0.4 0.16]; % iiwa7 0.126]
else
%     disp("iiwa14");

 l = [0.36 0.42 0.4 0.16]; % iiwa14
end
