function  [jPosd , eefError , eefdError , eefddError  ] = admittanceController(eefErrorLast,  eefdErrorLast ,  eefddErrorLast , ExEEFForce, iiwa, timeInt , eefTarget  , eefTargetd , jPos ,k_cartesian, b_cartesian, H_inv, KP)
% 导纳控制器 -- 笛卡尔空间
...
% iiwa, timeInt , eefTarget  , eefTargetd , jPos ,k_cartesian, b_cartesian, H_inv, KP)
% ================== parameters ==============================
